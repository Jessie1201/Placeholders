...
public class ItemadditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] SpinnerList ={getString(R.string.short_term),
                getString(R.string.medium_term),getString(R.string.long_term)};
    ...
    public void uploadImage(Uri uri) { //sends image to Cloudvision API
        if (uri != null) {
            try {
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        if (labels1 != null) { //gets the 2 biggest words in the picture
            double[] exes = {0,0,0,0};
            double[] ys = {0,0,0,0};double sz =0; double[] helper = {0,0,0,0,0,0};
